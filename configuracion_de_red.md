# Configuración de red<th colspan="3" style="text-align:center;width:100%;">[Parte 4: Gestión del Software en Vitalinux](http://wiki.vitalinux.educa.aragon.es/index.php/Curso_Aularagon/Parte_4)</th>
